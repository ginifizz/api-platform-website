  ...
  <section className="home__cover full">
    <div className="container cover__content">
      ...
      <div className="cover__buttons">
        <Button empty text="Download" icon="download" link="https://github.com/api-platform/api-platform/releases/latest" />
        <Button text="Get started" icon="flag" link="/docs/distribution/index" />
      </div>
    </div>
    <Flag />
  </section>
