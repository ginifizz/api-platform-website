...
export class Termynal {
   ...
   * @param {function} options.onComplete - function to call at the end of the animation
   */
  ...
  lineDataToElements(lineData) {
    return lineData.map((line) => {
      ...
      div.innerHTML = `<div ${this._attributes(line)}>${line.value || ''}</div>`;
